...
*/
const isThisAnEmail = (string) => string.includes('@') && string.includes('.')
console.log(isThisAnEmail('epicode@gmail.com'))
...
console.log(howManyDays(new Date('2024-03-01')))
...
console.log(isTodayMyBirthday('2001/03/15'))
...
const newestMovie = (obj) => {
  const array = obj.map((movie) => movie.Year)
...
*/
const countMovies = (obj) => obj.length
console.log(countMovies(movies))

/* ESERCIZIO 14
  Scrivi una funzione chiamata "onlyTheYears" che crea un array con solamente gli anni di uscita dei film contenuti nell'array "movies" fornito.
*/
const onlyTheYears = (obj) => obj.map((movie) => movie.Year)
console.log(onlyTheYears(movies))

/* ESERCIZIO 15
  Scrivi una funzione chiamata "onlyInLastMillennium" che ritorna solamente i film prodotto nel millennio scorso contenuti nell'array "movies" fornito.
*/
const onlyInLastMillennium = (obj) => obj.filter((movie) => movie.Year < 1999)
...
// const sumAllTheYears = (obj) => {
//   let sum = 0
//   const result = obj.forEach((movie) => {
...
*/
const searchByTitle = (obj, string) => {
...
*/
const findId = (tag) => document.getElementById(tag)
console.log(findId('container'))

/* ESERCIZIO 21
  Scrivi una funzione per selezionare ogni tag <td> all'interno della pagina.
*/
const selectAllTag = (tag) => document.querySelectorAll(tag)
console.log(selectAllTag('p'))

/* ESERCIZIO 22
  Scrivi una funzione che, tramite un ciclo, stampa in console il testo contenuto in ogni tag <td> all'interno della pagina.
*/
const readAllTag = (tag) => {
  const pos = selectAllTag(tag)
  pos.forEach((element) => {
...
*/
const addClassToallTag = (tag, name) => {
  const pos = selectAllTag('p')
  pos.forEach((element) => {
    element.classList.add(name)
  })
}
addClassToallTag('p', 'test')
